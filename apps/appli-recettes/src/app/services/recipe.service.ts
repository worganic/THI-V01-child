...
export class RecipeService {
  ...
  getUsers(): Observable<RecipeUser[]> {
    const url = environment.serviceVal + environment.serviceRecipeUsers;
  ...
  getBooks(): Observable<RecipeBook[]> {
    const url = environment.serviceVal + environment.serviceRecipeBook;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  saveBook(book: RecipeBook, isUpdate: boolean = false): Observable<string> {
    ...
    const url = environment.serviceVal + endpoint;
  ...
  deleteBook(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeBookDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }

  getBooksStats(): Observable<Record<string, BookStats>> {
    const urlCat = environment.serviceVal + environment.serviceRecipeCategory;
    const urlApp = environment.serviceVal + environment.serviceRecipeApplicatif;
    const urlSec = environment.serviceVal + environment.serviceRecipeSection;
    const urlTest = environment.serviceVal + environment.serviceRecipeTest;
    const urlSess = environment.serviceVal + environment.serviceTestSession;
    const urlCamp = environment.serviceVal + environment.serviceTestCampaign;
  ...
  getBooksQualityOverview(): Observable<BooksQualityOverview> {
    ...
    const urlSec = environment.serviceVal + environment.serviceRecipeSection;
    const urlTest = environment.serviceVal + environment.serviceRecipeTest;
    const urlTask = environment.serviceVal + environment.serviceRecipeTask;
  ...
  getCategories(bookId?: string): Observable<RecipeCategory[]> {
    ...
    const url = environment.serviceVal + environment.serviceRecipeCategory + queryParam;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteCategory(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeCategoryDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }

  getApplicatifs(categoryId?: string): Observable<RecipeApplicatif[]> {
    const queryParam = categoryId ? `?category_id=${categoryId}` : '';
    const url = environment.serviceVal + environment.serviceRecipeApplicatif + queryParam;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteApplicatif(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeApplicatifDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }

  getSections(applicatifId?: string): Observable<RecipeSection[]> {
    const queryParam = applicatifId ? `?applicatif_id=${applicatifId}` : '';
    const url = environment.serviceVal + environment.serviceRecipeSection + queryParam;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteSection(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeSectionDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }

  getTests(sectionId?: string): Observable<RecipeTest[]> {
    const queryParam = sectionId ? `?section_id=${sectionId}` : '';
    const url = environment.serviceVal + environment.serviceRecipeTest + queryParam;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteTest(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeTestDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }

  getTasks(testId?: string): Observable<RecipeTask[]> {
    const queryParam = testId ? `?test_id=${testId}` : '';
    const url = environment.serviceVal + environment.serviceRecipeTask + queryParam;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteTask(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceRecipeTaskDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }
  ...
  getSessions(): Observable<TestSession[]> {
    const urlSess = environment.serviceVal + environment.serviceTestSession;
    const urlResp = environment.serviceVal + environment.serviceTestResponse;
    const urlTask = environment.serviceVal + environment.serviceTestTaskResponse;
  ...
  deleteSession(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestSessionDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }
  ...
  clearSessionResults(session: TestSession): Observable<unknown> {
    ...
    if (session.responses) {
      Object.keys(session.responses).forEach(testId => {
        const urlDelTest = environment.serviceVal + environment.serviceTestResponseDelete;
    ...
    if (session.taskResponses) {
      Object.keys(session.taskResponses).forEach(taskId => {
        const urlDelTask = environment.serviceVal + environment.serviceTestTaskResponseDelete;
  ...
  saveTestResponse(payload: BackendTestResponsePayload): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestResponseInsert;
  ...
  updateTestResponse(payload: BackendTestResponsePayload): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestResponseUpdate2;
  ...
  uploadCapture(dataUrl: string): Observable<{ path: string }> {
    const url = environment.serviceVal + environment.serviceCaptureUpload;
  ...
  saveTaskResponse(payload: BackendTaskResponsePayload): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestTaskResponseInsert;
    return this.http.post(url, payload, { headers: this.headers, responseType: 'text' });
  }

  updateTaskResponse(payload: BackendTaskResponsePayload): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestTaskResponseUpdate2;
  ...
  getCampaigns(): Observable<TestCampaign[]> {
    const url = environment.serviceVal + environment.serviceTestCampaign;
    return this.http.get<unknown>(url, { headers: this.headers }).pipe(
      map(res => {
  ...
  deleteCampaign(id: string): Observable<string> {
    const url = environment.serviceVal + environment.serviceTestCampaignDelete;
    return this.http.post(url, { id }, { headers: this.headers, responseType: 'text' });
  }
}