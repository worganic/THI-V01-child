...
export const PORTAL_ROUTES: Routes = [
  ...
  // Page d'accueil publique. Elle occupait la racine ; celle-ci redirige
  // désormais vers /home comme dans l'autre portail, et l'écran de connexion
  // est à /connexion des deux côtés.
  {
    path: 'landing',
