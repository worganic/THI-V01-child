Liste des fonctions à tester (6) :

### 1-1-1 — Accès et navigation (Page: Landing — Fonctions métier)
...
### 1-1-2 — Formulaire de connexion (Page: Landing — Fonctions métier)
...
### 1-1-3 — États de la page (Page: Landing — Fonctions métier)
...
### 1-1-4 — Formulaire de création de compte (Page: Landing — Fonctions métier)
...
### 1-1-5 — Gestion d'erreur de la base de données (Page: Landing — Fonctions métier)
...
### 1-1-6 — Personnalisation et branding dynamiques (Page: Landing — Fonctions métier)
