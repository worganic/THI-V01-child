...
// ============================================================
// ROUTES: Read raw file (Admin Thème)
// ============================================================
...
// ============================================================
// ROUTES: Log édition (générique, consulté par plusieurs sous-applis)
// ============================================================
...
require('../apps/appli-recettes/server').register(app, { pool, getSessionUser });
require('../apps/appli-documents/server').register(app, { pool, getSessionUser });

// Routes de la sous-application projets (app NX autonome, port 4203) — reçoit
// en plus les fonctions de suivi de versions et de log d'édition, encore
// partagées avec la fonctionnalité transverse "WO Action History" (undo).
require('../apps/appli-projets/server').register(app, {
    pool, getSessionUser, logEdition, getPlatformSetting, setPlatformSetting,
...
1. Le CODE RÉEL du dépôt :
   ...
   - onglets Admin (registre des onglets), composants des pages (\`apps/portail/src/app/pages/...\`, \`apps/appli-projets/...\`),
...
app.listen(PORT, async () => {
    ...
    await require('../apps/appli-recettes/server').ensureSchema(pool);
    await require('../apps/appli-projets/server').ensureSchema(pool);
    await require('../apps/appli-documents/server').ensureSchema(pool);
    await pool.query(`
