/**
 * Worganic — Module Recettes : cahiers de recette, campagnes et sessions de test
 * de la sous-application `apps/appli-recettes` (montée dans le portail sur /recettes).
 *
 ...
 *
 * Montage : require('./modules/appli-recettes').register(app, { pool, getSessionUser })
 */
